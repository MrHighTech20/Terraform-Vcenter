...
Hey everyone. I created a Terraform file to use with a vSphere (vCenter server) without template. But, after you need setup VM, for example I used Ubuntu Server 24. 
